    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            (endDate.getHours()>8 || endDate.getHours()<=21) && startDate.getDay()!=6 && startDate.getDay()!=0
             && endDate.getDay()!=6 && endDate.getDay()!=0 && endDate.getHours()-startDate.getHours() <=1){
                $.ajax({
                ...
                alert("impossible : la durée doit etre de moins d'une heure et le jour est de lundi à vendredi et le temps de 8h à 21h");
            }
